    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-cogs"></span> 小游戏 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                	<li><a href="${ctx}/game/weijing/index.html"><span class="am-icon-cog"></span> 维京战争</a></li>
                    <li><a href="${ctx}/game/dayu/index.html"><span class="am-icon-cog"></span> 大鱼吃小鱼</a></li>
                    <li><a href="${ctx}/game/zhiwu/index.html"><span class="am-icon-cog"></span> 植物大战僵尸</a></li>
                    <li><a href="${ctx}/game/xiaoniao/index.html"><span class="am-icon-cog"></span> 像素小鸟</a></li>
...
<!--                 <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav"> -->
<%-- <%--                     <li><a href="${ctx}/${userid}/game/weijing"><span class="am-icon-group"></span> 维京战争</a></li> --%> 
<%-- <%--                     <li><a href="${ctx}/game/weijing/index.html"><span class="am-icon-cog"></span> 维京战争</a></li> --%> 
<%-- <%--                     <li><a href="${ctx}/game/dayu/index.html"><span class="am-icon-cog"></span> 大鱼吃小鱼</a></li> --%> 
<%--                 	<li><a href="${ctx}/${userid}/config"><span class="am-icon-group"></span> 个人设置</a></li> --%>
<!--                 </ul> -->
<!--             </li> -->
			<li><a href="${ctx}/${userid}/config" class="am-cf"><span class="am-icon-book"></span> 个人设置<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
