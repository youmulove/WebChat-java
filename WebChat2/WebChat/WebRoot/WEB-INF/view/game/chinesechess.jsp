...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "${ctx}/static/images/"+stype+"/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "${ctx}/static/images/"+stype+"/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "${ctx}/static/images/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "${ctx}/static/images/"+stype+"/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(${ctx}/static/images/"+stype+"/bg.jpg)";
...
<script src="${ctx}/static/js/play.js"></script> 
<script src="${ctx}/static/js/AI.js"></script> 
<script src="${ctx}/static/js/bill.js"></script> 
<script src="${ctx}/static/js/gambit.js"></script>
</body>
</html>