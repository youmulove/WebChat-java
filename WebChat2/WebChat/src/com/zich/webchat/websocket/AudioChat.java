...
public class AudioChat {
    ...
    public void onMessage(String message, Session session, @PathParam("uid")String uid) {
        ...
        try {
            if(uid != null && user_user.get(uid) != null && AudioChat.sessions.get(user_user.get(uid)) != null) {
    ...
    public static boolean addUser(String uid, String oid) {
        if(oid != null && !oid.isEmpty()) {                                                                                        
            AudioChat.user_user.put(uid, oid);
            AudioChat.user_user.put(oid, uid);

            return false;
        } else {
            AudioChat.user_user.put(uid, null);
