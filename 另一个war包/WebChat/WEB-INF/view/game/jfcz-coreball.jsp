...
<div id="begin">
	<section class="center-box">
		...
		<div class="op">
			<a id="btnFW" href="javascript:;"><img data-capture="1" src="${ctx}/static/source/img/btn_fw.png" /></a>
	...
	<section id="wxArrow" style="display: none;">
		...
		<img style="position: absolute;right:25px;" src="${ctx}/static/source/img/arrow.png" />
	</section>
</div>
<script src="${ctx}/static/source/js/jweixin-1.0.0.js"></script>
<script type="text/javascript" src="${ctx}/static/source/js/index.js"></script>
</body>
</html>