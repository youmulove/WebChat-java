                    ...
                    <form class="am-form am-form-horizontal">
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-10 am-u-sm-offset-2">
                                ...
                                <button type="button" class="am-btn am-round am-btn-success" onclick="javascript:history.go(-1)"><span class="am-icon-send"></span>返回</button>
                            </div>
                        </div>
                    </form>
                </div>
               ...
               <!--  <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" style="text-align: center;">
                        <div style="text-align: center;margin-bottom: 10px">
                            <img class="am-circle" src="http://s.amazeui.org/media/i/demos/bw-2014-06-19.jpg?imageView/1/w/1000/h/1000/q/80" width="140" height="140" alt="zich"/>
                        </div>
