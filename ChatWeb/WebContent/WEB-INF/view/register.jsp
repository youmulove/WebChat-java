...
<div class="login-form">
  ...
  <form id="login-form" action="<%=path%>/reg/register" method="post" onsubmit="return checkLoginForm()">
    <div class="key">
    ...
    <div class="signin">
      <div style = "float: none;"><input type="submit" id="submit" value="Register" >
      </div>
      <a href = "<%=path%>/user/login" style="color: #fff;">Login</a>
